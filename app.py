...
def predictRoute():
    try:
        ...
        os.system("cd yolov7/ && python detect.py --weights best.pt --img 416 --conf 0.5 --source ../data/inputImage.jpg")
...
def predictLive():
    try:
        os.system("cd yolov7/ && python detect.py --weights best.pt --img 416 --conf 0.5 --source 0")
        os.system("rm -rf yolov7/runs")
